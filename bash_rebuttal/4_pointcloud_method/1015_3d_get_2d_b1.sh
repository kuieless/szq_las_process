...
output_path=/data/yuqi/code/GP-NeRF-semantic/zyq_rebuttal_4/b1_$label_test
...
load_ply_path=/data/yuqi/code/GP-NeRF-semantic/bash_rebuttal/4_pointcloud_method/data/gt/gt_label_full_reversed_fineReg_trans.txt
