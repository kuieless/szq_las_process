...
python gp_nerf/eval.py \
    ...
    --exp_name zyq_rebuttal_4/eval_2d/yingrenshi_3d_voting_ours
...
python gp_nerf/eval.py \
    ...
    --exp_name zyq_rebuttal_4/eval_2d/yingrenshi_3d_voting_m2f
...
python gp_nerf/eval.py \
    ...
    --exp_name zyq_rebuttal_4/eval_2d/yingrenshi_3d_results_randlanet