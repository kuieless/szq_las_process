...
output_path=/data/yuqi/code/GP-NeRF-semantic/zyq_rebuttal_4/2d_to_3d/b1_labels_1028_ml_fusion_0.3
...
#需要修改的值
# far_project_m2f_paths   新的标签路径
output_path=/data/yuqi/code/GP-NeRF-semantic/zyq_rebuttal_4/2d_to_3d/b1_labels_m2f
