...
python gp_nerf/eval.py \
    ...
    --ckpt_path=logs_dji/1003_campus_density_depth_hash22/0/models/200000.pt --wgt_sem_loss=1 \
    ...
    --ckpt_path=/data/yuqi/code/GP-NeRF-semantic/logs_campus/1104_campus_density_depth_hash22_fusion1018_car2_semantic/0/models/160000.pt \
    --eval_others=True \
    --eval_others_name=3d_voting_ours  \
    --exp_name zyq_rebuttal_4/eval_2d/campus_3d_voting_ours
...
python gp_nerf/eval.py \
    ...
    --exp_name zyq_rebuttal_4/eval_2d/campus_3d_voting_m2f
...
python gp_nerf/eval.py \
    ...
    --exp_name zyq_rebuttal_4/eval_2d/campus_3d_results_randlanet