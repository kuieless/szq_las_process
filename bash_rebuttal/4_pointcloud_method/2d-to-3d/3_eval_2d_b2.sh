...
python gp_nerf/eval.py \
    ...
    --ckpt_path=logs_dji/1003_b2_density_depth_hash22/0/models/200000.pt --wgt_sem_loss=1 \
    ...
    --ckpt_path=/data/yuqi/code/GP-NeRF-semantic/logs_longhua_b2/1029_longhua_b2_density_depth_hash22_car2_semantic_1028_fusion/0/models/180000.pt \
    --eval_others=True \
    --eval_others_name=3d_voting_ours  \
    --exp_name zyq_rebuttal_4/eval_2d/b2_3d_voting_ours
...
python gp_nerf/eval.py \
    ...
    --exp_name zyq_rebuttal_4/eval_2d/b2_3d_voting_m2f
...
python gp_nerf/eval.py \
    ...
    --exp_name zyq_rebuttal_4/eval_2d/b2_3d_results_randlanet