...
output_path=/data/yuqi/code/GP-NeRF-semantic/zyq_rebuttal_4/RandLaNet/campus_gt
dataset_path=/data/yuqi/Datasets/DJI/Campus_new
load_ply_path=/data/yuqi/code/Urban3D-2021-2nd/data_campus/log_test/test_preds/visualize_label_ours.ply
