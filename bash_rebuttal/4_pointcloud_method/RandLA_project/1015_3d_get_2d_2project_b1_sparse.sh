...
output_path=/data/yuqi/code/GP-NeRF-semantic/zyq_rebuttal_4/RandLaNet/b1_sparse
dataset_path=/data/yuqi/Datasets/DJI/Longhua_block1_20231020_ds
load_ply_path=/data/yuqi/code/Urban3D-2021-2nd/data_b1_sparse/log_test/test_preds/visualize_label_ours.ply
