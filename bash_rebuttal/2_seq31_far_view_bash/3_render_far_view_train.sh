...
python  gp_nerf/eval.py \
    --exp_name logs_rebuttal/0127_seq31_geo_farview0.2_train_agu \
    ...
    --render_zyq   --render_zyq_far_view=render_far0.2


cd /data/yuqi/code/Mask2Former_a
output=/data/yuqi/code/GP-NeRF-semantic/logs_rebuttal/0127_seq31_geo_farview0.2_train_agu/0/eval_60000/val_rgbs
