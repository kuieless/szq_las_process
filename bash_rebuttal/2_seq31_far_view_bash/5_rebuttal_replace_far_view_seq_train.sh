...
val_dataset_path=$dataset_path/train
output_path=/data/yuqi/code/GP-NeRF-semantic/logs_rebuttal/0127_seq31_geo_farview0.2_train_agu/0/eval_60000/val_rgbs
far_paths=$output_path/1_labels_m2f_only_sam/labels_merge
render_type=render_far0.2
eval=False
...
#     --sam_features_path=$val_dataset_path/sam_features  \
#     --rgbs_path=$val_dataset_path/rgbs    \
#     --labels_m2f_path=/data/yuqi/code/Mask2Former_a/output/seq31/seq31_ds_10_train_ds2/labels_m2f_final  \
#     --output_path=/data/yuqi/code/Mask2Former_a/output/seq31/seq31_ds_10_train_ds2/labels_m2f_final_sam
...
/data/yuqi/anaconda3/envs/gpnerf/bin/python     /data/yuqi/code/GP-NeRF-semantic/bash_rebuttal/seq_far_view/1016_2_further_replace_car_tree_from_crop.py  \
    ...
    --crop_m2f=/data/yuqi/code/Mask2Former_a/output/seq31/seq31_ds_10_train_ds2/labels_m2f_final_sam/labels_merge  \
