...
def _get_train_opts() -> Namespace:
    ...
    parser.add_argument('--rgbs_path', type=str, default='/data/yuqi/Datasets/DJI/uavid/seq31/val/rgbs_original',required=False, help='')
    parser.add_argument('--save_path', type=str, default='/data/yuqi/Datasets/DJI/uavid/seq31/val/rgbs',required=False, help='experiment name')
