...
python  gp_nerf/eval.py \
    --exp_name logs_rebuttal/0127_seq31_geo_sem_ours_remapping \
    ...
    --ckpt_path=/data/yuqi/code/GP-NeRF-semantic/logs_rebuttal/2_seq31/0127_seq31_geo_sem_ours/0/models/200000.pt \
    --wgt_sem_loss=1 --separate_semantic=True --label_name=0125_rebu_0.2 --num_layers_semantic_hidden=3 --semantic_layer_dim=128 --lr=0.01 --balance_weight=True \
