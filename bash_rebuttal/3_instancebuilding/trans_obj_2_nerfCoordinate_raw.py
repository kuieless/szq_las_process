...
def _get_opts():
    ...
    parser.add_argument('--nerf_metadata_dir', default='/data/yuqi/jx_rebuttal/IB_test/3D/scene1/output', help='')
    parser.add_argument('--obj_filename', default='/data/yuqi/Datasets/InstanceBuilding/3D/scene1/scene1.obj', help='')
    parser.add_argument('--save_dir', default='/data/yuqi/jx_rebuttal/raw', help='')
