...
### 1104_process_campus_without_sam1018_val copy
...
/data/yuqi/anaconda3/envs/gpnerf/bin/python     /data/yuqi/code/GP-NeRF-semantic/scripts/1016_2_further_replace_car_tree_from_crop.py  \
    ...
    --crop_m2f=/data/yuqi/code/GP-NeRF-semantic/A_important_data/Mask2former_a_output/Campus/Campus_crop_ds2_val/labels_m2f_final_sam/labels_merge  \
