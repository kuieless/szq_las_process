...
#     --exp_name logs_rebuttal/0125_seq14_geo_farview0.3_train_agu \
...
#     --render_zyq   --render_zyq_far_view=render_far0.3


cd /data/yuqi/code/Mask2Former_a
output=/data/yuqi/code/GP-NeRF-semantic/logs_rebuttal/0125_seq14_geo_farview0.3_train_agu/0/eval_40000/val_rgbs
