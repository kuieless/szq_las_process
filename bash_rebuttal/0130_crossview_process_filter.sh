...
python /data/yuqi/code/GP-NeRF-semantic/tools/segment_anything/helpers/1103_get_sammask_autogenerate_depth_filter.py  \
    --output_path=/data/yuqi/code/GP-NeRF-semantic/zyq/0130_IB_instance_mask_0.001_process_depth_filter_20  \
    --threshold=0.001   \
...
#     --crossview_process_path=0130_IB_instance_mask_0.001_process
