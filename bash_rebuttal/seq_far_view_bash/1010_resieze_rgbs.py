...
def _get_train_opts() -> Namespace:
    ...
    parser.add_argument('--rgbs_path', type=str, default='/data/yuqi/jx_rebuttal/seq14_ds_10_val/postprocess/train/rgbs_original',required=False, help='')
    parser.add_argument('--save_path', type=str, default='/data/yuqi/jx_rebuttal/seq14_ds_10_val/postprocess/train/rgbs',required=False, help='experiment name')
...
def hello(hparams: Namespace) -> None:
    ...
    for image_path in tqdm(used_files):
        ...
        W, H = rgbs.size
        # W, H = int(W/4), int(H/4) 
        rgbs = rgbs.resize((int(W/2), int(H/2)), Image.LANCZOS)
