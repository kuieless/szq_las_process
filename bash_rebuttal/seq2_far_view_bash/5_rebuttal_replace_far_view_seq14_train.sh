...
output_path=/data/yuqi/code/GP-NeRF-semantic/logs_rebuttal/0125_seq14_geo_farview0.3_train_agu/0/eval_40000/val_rgbs
...
#     --sam_features_path=$val_dataset_path/sam_features  \
#     --rgbs_path=$val_dataset_path/rgbs    \
#     --labels_m2f_path=/data/yuqi/code/Mask2Former_a/output/seq14_ds_10_train_ds2/labels_m2f_final  \
#     --output_path=/data/yuqi/code/Mask2Former_a/output/seq14_ds_10_train_ds2/labels_m2f_final_sam
...
/data/yuqi/anaconda3/envs/gpnerf/bin/python     /data/yuqi/code/GP-NeRF-semantic/bash_rebuttal/seq_far_view/1016_2_further_replace_car_tree_from_crop.py  \
    ...
    --crop_m2f=/data/yuqi/code/Mask2Former_a/output/seq14_ds_10_train_ds2/labels_m2f_final_sam/labels_merge  \
