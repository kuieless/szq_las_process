...
for dataset2 in residence;do
    python scripts/save_depth.py  --exp_name   ./logs_357/test   \
        ...
        --ckpt_path  /data/yuqi/code/GP-NeRF-semantic/logs_357/0504_G_geo_$dataset2/0/models/200000.pt  --dataset_type  filesystem --debug  True
done
done