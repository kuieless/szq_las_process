...
def hello() -> None:
    ...
    use_silverman=False
    cluster_size=200
    output=f'1112_debug_campus_cluster_{num_points}_{cluster_size}_all_sammean'
    ...
    output_dir = 'logs_campus/1110_campus_density_depth_hash22_instance_origin_sam64/1/eval_100000/panoptic'
    ...
    sam_paths = []
    for ext in ('*.png', '*.npy'):
        sam_paths.extend(glob(os.path.join('/data/yuqi/Datasets/DJI/Campus_new/val/instances_mask_64', ext)))
    sam_paths.sort()
