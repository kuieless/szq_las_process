...
def hello() -> None:
    ...
    use_silverman=False
    cluster_size=1000
    output=f'1111_debug_campus_cluster_{num_points}'
    ...
    output_dir = 'logs_campus/1107_campus_density_depth_hash22_instance_origin_sam_0.001_depth_crossview/13/eval_100000/panoptic'
