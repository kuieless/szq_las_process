...
python /data/yuqi/code/GP-NeRF-semantic/paper_figure/4_crop_instance_GT.py \
    --input_path /data/yuqi/code/GP-NeRF-semantic/zyq/1117_cluster_b1/mean_sam/mean_depth_200000_1050 \
...
python /data/yuqi/code/GP-NeRF-semantic/paper_figure/4_crop_instance.py \
    --input_path /data/yuqi/code/GP-NeRF-semantic/zyq/1117_cluster_b1/mean_cross_view_all/mean_depth_200000_1000 \
    --output_path $output_path \
...
python /data/yuqi/code/GP-NeRF-semantic/paper_figure/4_crop_instance.py \
    --input_path /data/yuqi/code/GP-NeRF-semantic/logs_instance/1107_longhua_b1_density_depth_hash22_instance_origin_sam_0.001/0/eval_100000/panoptic \
    --output_path $output_path \
    --custom_name b1_LA_sam


python /data/yuqi/code/GP-NeRF-semantic/paper_figure/4_crop_instance.py \
    --input_path /data/yuqi/code/GP-NeRF-semantic/logs_instance/1108_longhua_b1_density_depth_hash22_instance_origin_sam_0.001_depth_crossview_all/0/eval_100000/panoptic \
    --output_path $output_path \
    --custom_name b1_LA_crossview_all


python /data/yuqi/code/GP-NeRF-semantic/paper_figure/4_crop_instance.py \
    --input_path /data/yuqi/code/GP-NeRF-semantic/logs_instance/1111_b1_detectron/0/eval_100000/panoptic \
    --output_path $output_path \
