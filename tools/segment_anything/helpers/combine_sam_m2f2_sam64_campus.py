...
def _get_train_opts() -> Namespace:
    ...
    parser.add_argument('--labels_m2f_path', type=str, default='/data/yuqi/code/Mask2Former_a/output/Campus_crop_ds2_val/labels_m2f_final',required=False, help='')
    parser.add_argument('--rgbs_path', type=str, default='/data/yuqi/Datasets/DJI/Campus_new/val/rgbs',required=False, help='')
    parser.add_argument('--output_path', type=str, default='/data/yuqi/code/Mask2Former_a/output/Campus_crop_ds2_val/labels_m2f_final_sam_64',required=False, help='')
...
def hello(hparams: Namespace) -> None:
    ...
    used_files = []
    for ext in ('*.npy', '*.jpg'):
        used_files.extend(glob.glob(os.path.join(img_path, ext)))
    used_files.sort()
