...
exp_name='logs_dji/0802_2_dsnerf_1'
...
python gp_nerf/train.py  --wandb_id  None   --exp_name  $exp_name   --enable_semantic  $enable_semantic  --pos_xyz_dim   $pos_xyz_dim  \
    ...
    --dataset_type $dataset_type   --depth_dji_loss   True     --wgt_sigma_loss  0    --wgt_depth_mse_loss  1



exp_name='logs_dji/0802_2_dsnerf_10'
