...
#     --rgbs_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/1104_yingrenshi_fusion2d_eval/pred_rgb


# #  接下来用 far的sam feature 和 m2f的building结果进行结合   
# python tools/segment_anything/helpers/combine_sam_m2f3_only_sam.py  \
#     --sam_features_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/1104_yingrenshi_fusion2d_eval/sam_features  \
#     --rgbs_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/1104_yingrenshi_fusion2d_eval/pred_rgb   \
#     --labels_m2f_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/1104_yingrenshi_fusion2d_eval/mask2former_output/labels_m2f  \
#     --output_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/1104_yingrenshi_fusion2d_eval/1_labels_m2f_only_sam



dataset_path=/data/yuqi/Datasets/DJI/Yingrenshi_20230926
far_paths=/data/yuqi/code/GP-NeRF-semantic/logs_dji/1104_yingrenshi_fusion2d_eval/1_labels_m2f_only_sam/labels_merge
output_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/1104_yingrenshi_fusion2d_eval
