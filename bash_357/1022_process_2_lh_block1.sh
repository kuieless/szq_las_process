...
python tools/segment_anything/helpers/combine_sam_m2f3_only_sam.py  \
    --sam_features_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1022_lh_block1_far0.3/sam_features  \
    --rgbs_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1022_lh_block1_far0.3/pred_rgb   \
    --labels_m2f_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1022_lh_block1_far0.3/mask2former_output/labels_m2f  \
    --output_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1022_lh_block1_far0.3/mask2former_output/labels_m2f_only_sam



dataset_path=/data/yuqi/Datasets/DJI/Longhua_block1_20231020_ds
far_paths=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1022_lh_block1_far0.3/mask2former_output/labels_m2f_only_sam/labels_merge
output_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1022_lh_block1_far0.3/project_to_ori_gt_only_sam
...
# 用投影回原图的building替换掉原始图的building
...
/home/yuqi/anaconda3/envs/gpnerf/bin/python     /data/yuqi/code/GP-NeRF-semantic/scripts/1016_2_further_replace_car_tree_from_crop.py  \
    --dataset_path=$dataset_path    \
    --exp_name=logs_357/test    \
    --only_sam_m2f_far_project_path=$output_path/project_far_to_ori_replace_building/replace_building_label  \
    --crop_m2f=/data/yuqi/code/Mask2Former_a/output/longhua_panoptic_b1_train_crop_ds2/labels_m2f_final_sam/labels_merge  \
    --output_path=$output_path/project_far_to_ori_replace_building_car_tree  \
