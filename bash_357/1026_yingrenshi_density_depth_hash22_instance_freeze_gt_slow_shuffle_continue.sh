...
ckpt_path=logs_dji/1026_yingrenshi_density_depth_hash22_instance_freeze_gt_slow_shuffle/0/models/100000.pt

# depth_dji_loss=True
# wgt_depth_mse_loss=1
lr=0.01
exp_name=logs_dji/1026_yingrenshi_density_depth_hash22_instance_freeze_gt_slow_shuffle
