...
#     --sam_features_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1022_lh_block2_far0.3/sam_features  \
#     --rgbs_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1022_lh_block2_far0.3/pred_rgb   \
#     --labels_m2f_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1022_lh_block2_far0.3/mask2former_output/labels_m2f  \
#     --output_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1022_lh_block2_far0.3/mask2former_output/labels_m2f_only_sam


##   2023.10.22 晚 23:16 正在跑

dataset_path=/data/yuqi/Datasets/DJI/Longhua_block2_20231020_ds
far_paths=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1022_lh_block2_far0.3/mask2former_output/labels_m2f_only_sam/labels_merge
output_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1022_lh_block2_far0.3/project_to_ori_gt_only_sam
