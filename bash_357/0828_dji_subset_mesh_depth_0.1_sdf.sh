...
exp_name=logs_dji/0828_dji_subset_mesh_depth_sdf_$wgt_depth_mse_loss
...
python gp_nerf/train.py  --exp_name  $exp_name  --config_file  $config_file   --dataset_path  $dataset_path   \
    ...
    --depth_dji_type   $depth_dji_type   --sampling_mesh_guidance    $sampling_mesh_guidance   --use_scaling False
