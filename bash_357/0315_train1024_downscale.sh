...
exp_name='logs_357/0315_train1024_downscale'
...
label_size=1024
train_scale_factor=8
desired_chunks=300
python gp_nerf/train.py     --config_file  configs/$dataset2.yaml   --dataset_path  /data/yuqi/Datasets/MegaNeRF/$dataset1/$dataset2/$dataset2-pixsfm    --chunk_paths   /data/yuqi/Datasets/MegaNeRF/$dataset1/${dataset2}_chunk-labels-$label_size-$train_scale_factor      --exp_name  $exp_name  --train_iterations   $train_iterations   --desired_chunks  15   --wgt_sem_loss   $wgt_sem_loss   --val_interval  $val_interval   --label_size   $label_size   --train_scale_factor  $train_scale_factor  --desired_chunks  $desired_chunks
