...
ckpt_path=logs_dji/1104_yingrenshi_density_depth_hash22_instance_origin_sam_0.001_duo/0/models/40000.pt
...
exp_name=logs_dji/1104_yingrenshi_density_depth_hash22_instance_origin_sam_0.001_duo
...
python gp_nerf/train.py  --exp_name  $exp_name   --enable_semantic  $enable_semantic  \
    ...
    --instance_loss_mode=$instance_loss_mode  --continue_train=True
