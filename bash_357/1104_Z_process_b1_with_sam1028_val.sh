...
#     --rgbs_path=/data/yuqi/code/GP-NeRF-semantic/logs_longhua_b2/1104_lh_b2_fusion2d_eval/pred_rgb


# #  接下来用 far的sam feature 和 m2f的building结果进行结合   
# python tools/segment_anything/helpers/combine_sam_m2f3_only_sam.py  \
#     --sam_features_path=/data/yuqi/code/GP-NeRF-semantic/logs_longhua_b2/1104_lh_b2_fusion2d_eval/sam_features  \
#     --rgbs_path=/data/yuqi/code/GP-NeRF-semantic/logs_longhua_b2/1104_lh_b2_fusion2d_eval/pred_rgb   \
#     --labels_m2f_path=/data/yuqi/code/GP-NeRF-semantic/logs_longhua_b2/1104_lh_b2_fusion2d_eval/mask2former_output/labels_m2f  \
#     --output_path=/data/yuqi/code/GP-NeRF-semantic/logs_longhua_b2/1104_lh_b2_fusion2d_eval/1_labels_m2f_only_sam



dataset_path=/data/yuqi/Datasets/DJI/Longhua_block2_20231020_ds
far_paths=/data/yuqi/code/GP-NeRF-semantic/logs_longhua_b2/1104_lh_b2_fusion2d_eval/1_labels_m2f_only_sam/labels_merge
output_path=/data/yuqi/code/GP-NeRF-semantic/logs_longhua_b2/1104_lh_b2_fusion2d_eval
...
# python tools/segment_anything/helpers/combine_sam_m2f3_only_sam.py  \
#     --sam_features_path=$dataset_path/val/sam_features  \
#     --rgbs_path=$dataset_path/val/rgbs   \
...
# # 用/data/yuqi/code/GP-NeRF-semantic/tools/segment_anything/helpers/combine_sam_m2f2_ds2crop_1022process_b2.sh
...
/home/yuqi/anaconda3/envs/gpnerf/bin/python     /data/yuqi/code/GP-NeRF-semantic/scripts/1016_2_further_replace_car_tree_from_crop.py  \
    ...
    --crop_m2f=/data/yuqi/code/Mask2Former_a/output/longhua_panoptic_b2_val_crop_ds2/labels_m2f_final_sam/labels_merge  \
