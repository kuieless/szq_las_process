...
#     --rgbs_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1028_lh_block1_far0.3/pred_rgb


#  接下来用 far的sam feature 和 m2f的building结果进行结合   
python tools/segment_anything/helpers/combine_sam_m2f3_only_sam.py  \
    --sam_features_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1028_lh_block1_far0.3/sam_features  \
    --rgbs_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1028_lh_block1_far0.3/pred_rgb   \
    --labels_m2f_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1028_lh_block1_far0.3/mask2former_output/labels_m2f  \
    --output_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1028_lh_block1_far0.3/1_labels_m2f_only_sam
...
# far_paths=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1028_lh_block1_far0.3/1_labels_m2f_only_sam/labels_merge
# output_path=/data/yuqi/code/GP-NeRF-semantic/logs_dji/augument/1028_lh_block1_far0.3
