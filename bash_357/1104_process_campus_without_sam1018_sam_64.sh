...
output_path=/data/yuqi/code/GP-NeRF-semantic/logs_campus/1104_campus_fusion2d_eval
...
/home/yuqi/anaconda3/envs/gpnerf/bin/python     /data/yuqi/code/GP-NeRF-semantic/scripts/1016_2_further_replace_car_tree_from_crop.py  \
    ...
    --crop_m2f=/data/yuqi/code/Mask2Former_a/output/Campus_crop_ds2_val/labels_m2f_final_sam_64/labels_merge  \
    --output_path=$output_path/5_replace_building_cartree_64  \
    --eval=True
