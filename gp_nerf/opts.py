...
def get_opts_base():
    ...
    parser.add_argument('--instance_name', type=str, default='instances_mask_0.01', choices=['instances_mask_0','instances_mask_0.01', 'instances_mask_0.001', 'instances_gt', 'instances_gt_noremapping'], help='')
