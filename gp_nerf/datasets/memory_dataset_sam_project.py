            ...
            if x2 >= 0 and x2 < self.W and y2 >= 0 and y2 < self.H:
                ...
                if self.visualization:
                    ...
                    if depth_diff > 0.02:
                        ...
                        cv2.imwrite(f"{save_dir}/{self.metadata_items[idx].image_path.stem}_occluded.jpg", img)
                        print(f"{save_dir}/{self.metadata_items[idx].image_path.stem}_occluded.jpg")
                    else:
                        cv2.imwrite(f"{save_dir}/{self.metadata_items[idx].image_path.stem}_project.jpg", img)
                        print(f"{save_dir}/{self.metadata_items[idx].image_path.stem}_project.jpg")
