...
# 输入视频
v1=/data/yuqi/code/GP-NeRF-semantic/A_Supplementary/semantic_video/rgb_yingrenshi.mp4
v2=/data/yuqi/code/GP-NeRF-semantic/A_Supplementary/semantic_video/depth_yingrenshi.mp4
v3=/data/yuqi/code/GP-NeRF-semantic/A_Supplementary/semantic_video/ours_yingrenshi.mp4
v4=/data/yuqi/code/GP-NeRF-semantic/A_Supplementary/instance_video/c_instance_yingrenshi.mp4

# 输出视频
output_video=/data/yuqi/code/GP-NeRF-semantic/A_Supplementary/all/all_campus.mp4
