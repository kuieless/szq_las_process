...
# 输入视频
v1=/data/yuqi/code/GP-NeRF-semantic/A_Supplementary/semantic_video/rgb_campus.mp4
v2=/data/yuqi/code/GP-NeRF-semantic/A_Supplementary/semantic_video/depth_campus.mp4
v3=/data/yuqi/code/GP-NeRF-semantic/A_Supplementary/semantic_video/ours_campus.mp4
v4=/data/yuqi/code/GP-NeRF-semantic/A_Supplementary/instance_video/c_instance_campus.mp4
