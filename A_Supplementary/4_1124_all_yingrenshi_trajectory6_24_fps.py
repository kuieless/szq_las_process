...
def hello(data_dir, n_out_poses, key_poses):
    ...
    out_poses2 = inter_poses(traj2, 18)
    ...
    out_poses4 = inter_poses(traj4, 18)
    ...
    out_poses6 = inter_poses(traj6, 60)
    ...
    out_poses7 = inter_poses(traj7, 24)




    out_poses = np.concatenate([out_poses1,out_poses2,out_poses3,out_poses4,out_poses5,out_poses6, out_poses7],0)
