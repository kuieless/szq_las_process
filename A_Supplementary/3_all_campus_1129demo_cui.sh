...
# 输入视频
v1=/data/yuqi/code/GP-NeRF-semantic/A_Supplementary_trajectory/campus/0/pred_rgb.mp4
v2=/data/yuqi/code/GP-NeRF-semantic/A_Supplementary_trajectory/campus/0/pred_depth.mp4
v3=/data/yuqi/code/GP-NeRF-semantic/A_Supplementary_trajectory/campus/0/pred_label_alpha.mp4
v4=/data/yuqi/code/GP-NeRF-semantic/A_Supplementary_trajectory/campus/0/instance.mp4

# 输出视频
output_video=/data/yuqi/code/GP-NeRF-semantic/A_Supplementary/all/all_campus_1129demo_cui.mp4
