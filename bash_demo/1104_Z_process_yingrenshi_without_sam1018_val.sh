...
#         --rgbs_path=/data/yuqi/Datasets/DJI/xiayuan_20240118_demo/val/rgbs


# # # 先对nerf渲染的far图像进行sam feature提取   
# python /data/yuqi/code/GP-NeRF-semantic/tools/segment_anything/helpers/extract_embeddings.py   \
#     --rgbs_path=/data/yuqi/code/GP-NeRF-semantic/logs_demo/0120_cuhksz_demo_geo_renderfar/pred_rgb


# #  接下来用 far的sam feature 和 m2f的building结果进行结合   
# python tools/segment_anything/helpers/combine_sam_m2f3_only_sam.py  \
#     --sam_features_path=/data/yuqi/code/GP-NeRF-semantic/logs_demo/0120_cuhksz_demo_geo_renderfar/sam_features  \
#     --rgbs_path=/data/yuqi/code/GP-NeRF-semantic/logs_demo/0120_cuhksz_demo_geo_renderfar/pred_rgb   \
#     --labels_m2f_path=/data/yuqi/code/GP-NeRF-semantic/logs_demo/0120_cuhksz_demo_geo_renderfar/mask2former_output/labels_m2f  \
#     --output_path=/data/yuqi/code/GP-NeRF-semantic/logs_demo/0120_cuhksz_demo_geo_renderfar/1_labels_m2f_only_sam



dataset_path=/data/yuqi/Datasets/DJI/xiayuan_20240118_demo
far_paths=/data/yuqi/code/GP-NeRF-semantic/logs_demo/0120_cuhksz_demo_geo_renderfar/1_labels_m2f_only_sam/labels_merge
output_path=/data/yuqi/code/GP-NeRF-semantic/logs_demo/0120_cuhksz_demo_geo_renderfar
render_type=render_far0.3
eval=False


# 这里 把far图像投影回原始图
# python   /data/yuqi/code/GP-NeRF-semantic/scripts/1015_0_3d_get_2d_label_gy_filter_far_to_ori.py \
...
python    /data/yuqi/code/GP-NeRF-semantic/scripts/1016_1_only_sam_building_label_replace_nocar.py  \
    --dataset_path=$dataset_path    \
    --exp_name=logs_357/test    \
...
#     --crop_m2f=/data/yuqi/code/Mask2Former_a/output_useful/yingrenshi_crop_ds2_val/labels_m2f_final_sam/labels_merge  \
