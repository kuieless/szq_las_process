...
def _get_train_opts() -> Namespace:
    ...
    parser.add_argument('--rgbs_path', type=str, default='/data/yuqi/Datasets/DJI/xiayuan_20240118_demo/val/rgbs_orisize',required=False, help='')
    parser.add_argument('--save_path', type=str, default='/data/yuqi/Datasets/DJI/xiayuan_20240118_demo/val/rgbs',required=False, help='experiment name')
