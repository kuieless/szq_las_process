...
freeze_geo=True
label_name=0123_ml_fusion_0.3
separate_semantic=True
ckpt_path=logs_demo/0120_cuhksz_demo_geo/0/models/300000.pt

# depth_dji_loss=True
# wgt_depth_mse_loss=1
lr=0.01
exp_name=logs_demo/0123_cuhksz_demo_semantic
...
python gp_nerf/train.py  --exp_name  $exp_name   --enable_semantic  $enable_semantic  \
    ...
    --use_subset=False      --lr=$lr    --balance_weight=True   --num_semantic_classes=5  
