...
## 这是没加air 监督的
exp_name=logs_dji/0810_2_G_sampling_guidance_10m
...
python gp_nerf/train.py  --wandb_id  None   --exp_name  $exp_name   --enable_semantic  $enable_semantic  --pos_xyz_dim   $pos_xyz_dim  \
    ...
    --dataset_type $dataset_type   --depth_dji_loss   True     --wgt_sigma_loss  0    --wgt_depth_mse_loss  0 \
    --depth_dji_type  $depth_dji_type    --sample_mesh_surface    True   --around_mesh_meter   10
