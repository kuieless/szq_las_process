...
exp_name='logs_357/0324_seperate_3'
...
python gp_nerf/train.py     --config_file  configs/$dataset2.yaml   --dataset_path  /data/yuqi/Datasets/MegaNeRF/$dataset1/$dataset2/$dataset2-pixsfm    --chunk_paths   /data/yuqi/Datasets/MegaNeRF/$dataset1/${dataset2}_chunk-labels-$label_size-1      --exp_name  $exp_name  --train_iterations   $train_iterations   --desired_chunks  15     --val_interval  $val_interval   --label_size   $label_size  --stop_semantic_grad  $stop_semantic_grad  --use_pano_lift  $use_pano_lift   --ckpt_path  $ckpt_path    --no_resume_ckpt_state  --network_type  $network_type
