...
wgt_sigma_loss=0.0000000001

exp_name=logs_dji/0802_3_dsnerf_sigma_$wgt_sigma_loss
...
python gp_nerf/train.py  --wandb_id  None   --exp_name  $exp_name   --enable_semantic  $enable_semantic  --pos_xyz_dim   $pos_xyz_dim  \
    ...
    --dataset_type $dataset_type   --depth_dji_loss   True     --wgt_sigma_loss  $wgt_sigma_loss    --wgt_depth_mse_loss  0
