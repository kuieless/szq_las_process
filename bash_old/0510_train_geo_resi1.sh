...
# gpu=${1:-6}
# exp=${2:-''}
export CUDA_VISIBLE_DEVICES=5  #${gpu}

exp_name='logs_357/0510_train_geo_residence_old'    #${exp}
...
args=${args}" --normal_loss False  --depth_loss False --add_random_rays  False  --sample_random_num  $sample_random_num"
